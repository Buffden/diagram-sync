...
| `type` | `string` | Diagram provider (`plantuml`, `mermaid`, `graphviz`, `drawio`, `d2`, `excalidraw`, `bpmn`, `erd`) |
...
| ERD | `.er` | Supported | [Setup & CI/CD](https://github.com/Buffden/diagram-sync/tree/main/docs/providers/erd) |
...
- Each provider requires its own CLI tool — install only what you need:
  ...
  - **ERD:** requires `erd` CLI and Graphviz — see [ERD guide](https://github.com/Buffden/diagram-sync/tree/main/docs/providers/erd)
...
- **How to generate ER diagrams automatically from schema files in CI/CD**
